...
from lib_piglet.expanders.pddl_expander import (
    pddl_optimal_relaxation_expander,
    pddl_greedy_relaxation_expander,
)
...
def greedy_delete_relaxation_h(domain, current_state, goal_state):
    ...
    relaxed_solution = relaxed_search.get_path(
        copy.deepcopy(current_state), relaxed_goal
    )
